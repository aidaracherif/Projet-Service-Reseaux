...
<head>
    ...
    <!-- SweetAlert2 pour alertes modernes -->
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('employes.index') }}">
                            <i class="fa-solid fa-list"></i> Liste des Employés
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-primary text-white px-3" href="{{ route('employes.create') }}">
